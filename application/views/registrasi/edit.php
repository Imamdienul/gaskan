            ...
            <div class="border border-primary p-3">
                ...
                <div class="row mb-3">
                    <div class="col-md-7">
                        <div class="form-group required">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="fprovinsi_identitas" id="fprovinsi_identitas" class="form-control select2" required>
                                        ...
                                        <?php foreach ($provinsi as $prov) : ?>
                                            <option value="<?= $prov->id ?>" <?= $regis->provinsi_identitas == $prov->id ? 'selected' : '' ?>><?= $prov->nama ?></option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="fdetail_alamat_identitas" id="fdetail_alamat_identitas" class="form-control" rows="3" placeholder="Masukkan detail alamat identitas (Jalan, No. Rumah, dll)" required><?= $regis->alamat_identitas ?></textarea>
                    ...
                    <div class="col-md-5">
                        ...
                        <a href="javascript:;" data-id="<?= encrypt_url($regis->id_registrasi_customer)  ?>" data-toggle="modal" data-target="#edit-data" data-toggle="tooltip" title="EDIT DATA" class="btn btn-sm btn-default">Edit Foto Identitas</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                            ...
                            <div id="alamat_pemasangan_section">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="fprovinsi_pemasangan" id="fprovinsi_pemasangan" class="form-control select2" required>
                                            <option value="">-- Pilih Provinsi --</option>
                                            <?php foreach ($provinsi as $prov) : ?>
                                                <option value="<?= $prov->id ?>" <?= $regis->provinsi_pemasangan == $prov->id ? 'selected' : '' ?>><?= $prov->nama ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="frt" id="frt" class="form-control" placeholder="RT" value="<?= $regis->rt ?>" required>
                                        <?= form_error('frt') ?>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="frw">RW *</label>
                                        <input type="text" name="frw" id="frw" class="form-control" placeholder="RW" value="<?= $regis->rw ?>" required>
                                        <?= form_error('frw') ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="fdetail_alamat_pemasangan">Detail Alamat Pemasangan *</label>
                                    <textarea name="fdetail_alamat_pemasangan" id="fdetail_alamat_pemasangan" class="form-control" rows="3" placeholder="Masukkan detail alamat pemasangan (Jalan, No. Rumah, dll)" required><?= $regis->alamat_pemasangan ?></textarea>
