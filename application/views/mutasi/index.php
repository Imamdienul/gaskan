...
<section class="content">
                                ...
                                foreach ($mutasi as $key) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="btn btn-xs btn-danger" onclick="deleteConfirm('<?= base_url() . 'mutasi/delete_mutasi/' . encrypt_url($key->id_mutasi) ?>')">DELETE</a>
    ...
    <textarea name="flokasi_barang" class="form-control <?= form_error('flokasi_barang') ? 'is-invalid' : '' ?> text-uppercase" id="flokasi_barang" placeholder="sertakan alamat penyimpanan barang"><?= $this->input->post('flokasi_barang'); ?></textarea>
    <div class="invalid-feedback">
