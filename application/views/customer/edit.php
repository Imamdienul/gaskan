                ...
                <div class="card">
                    ...
                    <form role="form" method="POST" action="" autocomplete="off">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group required">
                                <label class="control-label" for="falamat_detail">Detail Alamat</label>
                                <textarea name="falamat_detail"
                                    class="form-control <?= form_error('falamat_detail') ? 'is-invalid' : '' ?>"
                                    id="falamat_detail" 
                                    placeholder="Masukkan detail alamat (nama jalan, nomor rumah, RT/RW, dll)"><?= isset($alamat_detail) ? $alamat_detail : '' ?></textarea>
                                <div class="invalid-feedback">
